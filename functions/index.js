...
exports.sendNotificationRV = functions.database
  ...
  .onWrite((change, context) => {
    ...
    .then(function(snapshot){
      ...
      return admin
        ...
        .send(payload)
        .then(function(response) {
          return console.log("Successfully sent message RV:", response);
        })
        .catch(function(error) {
          return console.log("Error sending message RV:", error);
        });
  });
});